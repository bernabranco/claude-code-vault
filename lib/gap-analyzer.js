 ...
 * buildVaultHaystack.
 *
 * Reads files on-demand from disk; vault.index only carries a lowercased body
 * mirror (`_bodyLower`, non-enumerable) which is intentionally different from
 * the original raw body this helper needs.
 */
